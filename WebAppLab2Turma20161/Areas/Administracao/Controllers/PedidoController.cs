...
namespace Areas.Administracao.Controllers
{
    ...
    public class PedidoController : Controller
    {
        ...
        public ActionResult ConsultarCliente(int? pagina, string nomeCliente = null)
        {
            ...
            {
                cliente = db.Pedidos.OrderBy(p => p.Nome).ToPagedList(numeroPagina, tamanhoPagina);
            }
        ...
        public ActionResult Index(string ordenacao, int? pagina)
        {
            ...
            switch (ordenacao)
            {
                case "Nome_desc":
                    ...
                    break;
                case "DataPedido":
                    pedidos = pedidos.OrderBy(s => s.DataRegistro);
                    break;
                case "DataPedido_desc":
                    pedidos = pedidos.OrderByDescending(s => s.DataRegistro);
                    break;
                case "DataEenvio":
